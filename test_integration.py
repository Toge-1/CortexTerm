...
# Ensure we can import cortexterm
sys.path.insert(0, str(Path(__file__).parent))

print("=" * 70)
print("  CortexTerm - Integration Test")
print("=" * 70)
print()
...
def test_import_core():
    ...
    try:
        from cortexterm import agent_loop, config, permissions, prompt, skills
        from cortexterm import tooling, mcp, history, workspace
        return True
...
def test_import_new_features():
    ...
    try:
        from cortexterm import state, cost_tracker, context_manager
        from cortexterm import api_retry, task_tracker, memory
        from cortexterm import poly_commands, async_context, sub_agents
        from cortexterm import auto_mode, hooks, session, install
        return True
    except ImportError as e:
...
def test_store_state():
    ...
    from cortexterm.state import Store, AppState, create_app_store
    ...
    # Update state
    from cortexterm.state import set_busy, set_idle, update_context_usage
...
def test_task_tracker():
    """Test task tracking."""
    from cortexterm.task_tracker import TaskManager
...
def test_poly_commands():
    ...
    from cortexterm.poly_commands import (
...
def test_auto_mode():
    ...
    from cortexterm.auto_mode import (
...
def test_sub_agents():
    ...
    from cortexterm.sub_agents import (
...
def test_api_retry():
    ...
    from cortexterm.api_retry import (
...
def test_session_persistence():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("cortexterm.session.SESSIONS_DIR", tmp_path / "sessions"), \
...
def test_async_context():
    ...
    import asyncio
    from cortexterm.async_context import AsyncContextCollector
