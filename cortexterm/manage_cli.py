...
from cortexterm.config import get_mcp_config_path, load_scoped_mcp_servers, save_scoped_mcp_servers
from cortexterm.skills import discover_skills, install_skill, remove_managed_skill


def _print_usage() -> None:
    print(
        "cortexterm management commands\n\n"
        "cortexterm mcp list [--project]\n"
        "cortexterm mcp add <name> [--project] [--protocol <auto|content-length|newline-json>] [--env KEY=VALUE ...] -- <command> [args...]\n"
