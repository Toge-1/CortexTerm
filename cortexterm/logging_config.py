"""Logging configuration for CortexTerm.
...
# 日志文件路径
LOG_FILE = CORTEXTERM_DIR / "cortexterm.log"
...
def setup_logging(
    ...
    # 创建根 logger
    root_logger = logging.getLogger("cortexterm")
...
def get_logger(name: str) -> logging.Logger:
    ...
    Returns:
        配置好的子 logger
    """
    return logging.getLogger(f"cortexterm.{name}")
