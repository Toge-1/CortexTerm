...
from cortexterm.context_manager import (
    ContextManager,
    ContextStats,
...
from cortexterm.task_tracker import (
    Task,
    TaskList,
    TaskManager,
    TaskStatus,
...
def test_context_manager_persistence(tmp_path):
    ...
    with patch("cortexterm.context_manager.CORTEXTERM_DIR", tmp_path):
