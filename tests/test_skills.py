...
from cortexterm.skills import discover_skills, load_skill


def test_discover_skills_prefers_project_root(tmp_path: Path, monkeypatch) -> None:
    project_skill = tmp_path / ".cortexterm" / "skills" / "demo" / "SKILL.md"
    ...
    user_skill = user_home / ".cortexterm" / "skills" / "demo" / "SKILL.md"
