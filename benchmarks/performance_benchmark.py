"""Performance benchmark suite for CortexTerm.
...
# Add parent directory to path to import cortexterm
import sys
sys.path.insert(0, str(Path(__file__).parent.parent))

from cortexterm.context_manager import estimate_tokens, estimate_message_tokens
...
def benchmark_terminal_rendering() -> list[BenchmarkResult]:
    ...
    from cortexterm.tui.transcript import render_transcript
...
def run_all_benchmarks() -> list[BenchmarkResult]:
    ...
    print("=" * 80)
    print("CortexTerm Performance Benchmark")
    print("=" * 80)
    print()
...
if __name__ == "__main__":
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("CortexTerm Benchmark Results\n")
        f.write("=" * 80 + "\n\n")
        for r in results:
